...
const VEHICLES = ['highwater','redline','blackwater','tidal','pearl','violet','silverback','paddle'];
    ...
    try{
      ...
      const result=await storage.transact(rawStore=>{
        ...
        if(action==='create'||action==='join'){
          ...
          if(room.restriction==='atv'&&custom.vehicle==='tidal'||room.restriction==='sxs'&&custom.vehicle!=='tidal')throw fail('Your vehicle does not match this lobby restriction. Change it in the garage.');
